# Diffusion-Limited Aggregation simulation that shows how crystals and other structures form
import numpy as np
...
anim.save(os.path.join(RESULTS_DIR, 'anim1.gif'), writer='pillow', fps=10)
plt.close()